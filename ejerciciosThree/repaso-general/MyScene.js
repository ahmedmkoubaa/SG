...
import { ModeloJerarquico } from './ModeloJerarquico.js'
...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.add (this.axis);
	 ...
	 this.objetoRevolucion = new Revolucion(this.gui, "Controles del objeto");
	 this.barrido = new Barrido(this.gui, "Controles del barrido");
	 this.csg = new Csg(this.gui, "Controles del CSG");
	 this.modelo = new MyLoadedModel('../models/arbol/DeadTree.mtl', '../models/arbol/DeadTree.obj');
	 this.grua = new ModeloJerarquico(this.gui, "Controles de la grua");
