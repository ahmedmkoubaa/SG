...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.add (this.axis);
	 ...
	 // -----------------------------------------------------------------------//
	 // CREACION DE OBJETOS
	 this.comecoco = new Comecoco(this.gui, "Controles del comecoco");
	 this.add(this.comecoco);
	 ...
	 var movimiento1 = new TWEEN.Tween(origen1).to(destino1, 6000);

	 var that = this;
	 movimiento1.onUpdate(function() {
		 that.actualizaAnimacion(that.comecoco, origen1.x);
	 });
	 ...
	 movimiento2.onUpdate(function() {
		 that.actualizaAnimacion(that.comecoco, origen2.x);
	 });
	 ...
	 movimiento2.easing(TWEEN.Easing.Cubic.InOut).onComplete(function(){ origen2.x = 0.6; });
	 ...
	 this.comecoco.scale.set(0.5, 0.5, 0.5);
